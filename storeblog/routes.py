...
from storeblog import application, db, bcrypt, mail
from storeblog.forms import (RegistrationForm, LoginForm, UpdateAccountForm,
                             PostForm, RequestResetForm, ResetPasswordForm)
from storeblog.models import User, Post
...
def save_picture(form_picture):
    ...
    picture_path = os.path.join(application.root_path, 'static/profile_pic', picture_fn)
...
def send_reset_email(user):
    ...
    msg = Message('Password Reset Request',
                  sender='sekinatanimashaunsal@gmail.com',
